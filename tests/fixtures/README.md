...
| `multipage.pdf`                         | 33-page landscape US Letter “The Complete Guide to Building Skills for Claude” | Optional long-document Ask PDF retrieval; editor/page interaction tests; standalone merge             | `66cbcc06df9271e0bb59986582646f0c4c7c94697554f893f937a5a55cef736d` |
...
- `tests/e2e/ai-tools.e2e.ts` uses `sample.pdf` by default. Run with
  `FIXTURE=multipage` to exercise retrieval over the 33-page skill-building
  guide.
