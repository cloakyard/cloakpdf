// Grainient.tsx — WebGL2 animated noise/gradient backdrop. Renders a
// fullscreen triangle through ogl with a fragment shader that blends
// three colors, warps with a sine field, and tops the result with film
// grain. The component is a pure backdrop; size it via the parent.
